<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Admin-MarketingDetails.aspx.cs" Inherits="goGst.Admin_MarketingDetails" %>
      ...
      <nav aria-label="breadcrumb mt-3">
       ...
       <div class="offcanvas-body">
            <div class="container">
                <div class="support">
                    <div class="col-lg-12">
                        <h4 style="font-weight: bold; text-align: center;">Marketing Employee Profile</h4>
...
Status<span style="color:red;">*</span>
                        ...
                        <div class="col-lg-9">
                            <asp:Button ID="btnupdate" OnClick="btnupdate_Click1" runat="server" Text="Update"  Class="btn offset-6" Style="background-color: #ce8f28; color: white;" />
                            <asp:Button ID="btnCancle" runat="server" PostBackUrl="~/Manage-Marketing.aspx"  Text="Cancle" Class="btn offset-1" Style="background-color: #ce8f28; color: white;" />
                        </div>
                    </div>
                </div>
            </div>
