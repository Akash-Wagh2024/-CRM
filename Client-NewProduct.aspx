<%@ Page Title="" Language="C#" MasterPageFile="~/Site4.Master" AutoEventWireup="true" CodeBehind="Client-NewProduct.aspx.cs" Inherits="goGst.Client_NewProduct" %>
                            ...
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="modal-footer justify-content-evenly">
                                        <asp:LinkButton ID="btnUpdate" runat="server" OnClick="btnUpdate_Click" OnClientClick="return confirm('Do you want to send this product request?');" CommandArgument='<%# Eval("product_id") %>' CssClass="btn" Style="margin-right: 6px; font-size: 12px; border-radius: 5px; padding: 6px 13px; background-color: rgba(23, 208, 83, 0.21); border: none;">
